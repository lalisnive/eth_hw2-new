...
contract Bank {
    ...
    function mint(uint256 coinValue) public isOwner {
        ...
        // your code
	require(value / coinValue == 1 ether, "safe");
        require(coinBalance[msg.sender] >= coinBalance[msg.sender] - value , "safe");
    ...
    function buy(uint256 coinValue) public {
        ...
        // your code
	        require( value<=coinBalance[owner]);
        ...
        // your code
        require(balance[msg.sender] <= balance[msg.sender]+value, "safe");        
        balance[msg.sender] =balance[msg.sender]- value;
        // owner 的 etherBalance 增加 value
        // your code
        require(balance[owner] >= balance[owner]-value, "safe");        
        ...
        // your code
        require(coinBalance[owner] <= coinBalance[owner]+value, "safe");  
    ...
    function transferCoin(address to, uint256 coinValue) public {
        ...
        // your code
	        require(value<=coinBalance[msg.sender]);
        ...
        // your code
	require(coinBalance[to]  >= coinBalance[to]-value, "safe");  
